// derived from: https://github.com/dotnet/roslyn/blob/main/src/Compilers/CSharp/Portable/Syntax/SyntaxKind.cs
...
#pragma warning disable CA1200 // Avoid using cref tags with a prefix - The prefix is required since this file is referenced in projects that can't access syntax nodes
    ...
    public enum SK : ushort
    {
        None = 0,
        List = 1,//GreenNode.ListKind,// ここだけパッと削ってしまった。値はオリジナルのものを持ってきている。
        ...
        OutOfKind = 10000,// 追加,None以外に終了サインが欲しかったので。
    }
}